...
red_left_circle_x = -22
red_left_circle_y = 14

red_left_letter_x = red_left_circle_x-4
red_left_letter_y = red_left_circle_y-2



# red right circle (오른쪽 - 빨간 테두리) 

red_right_circle_x = 20
...
zone_left_letter_x = zone_left_circle_x-6
...
zone_right_circle_x = red_right_circle_x
zone_right_circle_y = red_right_circle_y

zone_right_letter_x = red_right_circle_x-6
zone_right_letter_y = red_right_circle_y+14
...
# Import Data
pathname = "/Users/Jace/heatmap/221021 social behavior try 3/excel_raw processed/csv/221019 vgat piezo1 m torquer social behavior-Trial1_no.220 vgat Piezo1+m-torquer mouse2 vs mouse1.csv"
...
plt.text(red_left_letter_x, red_left_letter_y, "M2", fontsize=18, color = "white", alpha=1)
...
plt.text(zone_left_letter_x, zone_left_letter_y, "M2 zone", fontsize=10, color = "white", alpha=1)
...
print("the time in the 'M1' zone is", time_counter_fz1, "seconds", "and", "the time in the 'M2' zone is", time_counter_fz2, "seconds")

'''print calculated values onto the plot'''
plt.text(-48,-45, 'Time spent in M1 zone = %.2f sec\nTime spent in M2 zone = %.2f sec' % (time_counter_fz1, time_counter_fz2), fontsize=10, color = "white", alpha=1)
